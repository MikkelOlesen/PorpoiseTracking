...
config_path='yolo_object_detector/dnn_tracker_needs/yolov3-custom.cfg'
weights_path='yolo_object_detector/dnn_tracker_needs/yolov3_ckpt_60.pth'
class_path='yolo_object_detector/dnn_tracker_needs/classes.names'
